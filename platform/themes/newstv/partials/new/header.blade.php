...
<body @if (class_exists('Language', false) && Language::getCurrentLocaleRTL()) dir="rtl" class="ar-lang" @endif>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="header-logo col-md-4 d-none d-md-block">
                    <a href="index.html" class="logo"><img src="/themes/newstv/pad/img/logo.png" alt="Logo"></a>
                </div>

                <!-- Header Banner -->
                <div class="header-banner col-md-8 col-12">
                    <div class="banner"><a href="#"><img src="/themes/newstv/pad/img/banner/header-banner-1.png" alt="Header Banner"></a></div>
                </div>

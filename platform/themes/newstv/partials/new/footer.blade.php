        ...
        <div class="row">
            ...
            <div class="footer-widget col-xl-3 col-md-6 col-12 mb-60">
                ...
                <div class="footer-widget-post">
                    <div class="post-wrap">
                        ...
                        <!-- Image -->
                        <a href="{{ $post->url }}" class="image"><img src="/themes/newstv/pad/img/post/post-33.jpg" alt="Post"></a>

                        <!-- Content -->
                        <div class="content">

                            <!-- Title -->
                            <h5 class="title"><a href="{{ $post->url }}">Hynpodia helps male travelers find healths.</a></h5>
                ...
                <div class="footer-widget-post">
                    <div class="post-wrap">
                        ...
                        <!-- Image -->
                        <a href="{{ $post->url }}" class="image"><img src="/themes/newstv/pad/img/post/post-34.jpg" alt="Post"></a>

                        <!-- Content -->
                        <div class="content">

                            <!-- Title -->
                            <h5 class="title"><a href="{{ $post->url }}">How do you solve the IOS page problem.</a></h5>
                ...
                <div class="footer-widget-post">
                    <div class="post-wrap">
                        ...
                        <!-- Image -->
                        <a href="{{ $post->url }}" class="image"><img src="/themes/newstv/pad/img/post/post-35.jpg" alt="Post"></a>

                        <!-- Content -->
                        <div class="content">

                            <!-- Title -->
                            <h5 class="title"><a href="{{ $post->url }}">Home is not a place . . . . . .  . it’s a feeling.</a></h5>
            ...
            <div class="footer-widget col-xl-3 col-md-6 col-12 mb-60">
                ...
                <div class="single-tweet">
                    ...
                    <!-- Image -->
                    <a href="#" class="image"><img src="/themes/newstv/pad/img/tweets/1.png" alt="Author Image"></a>
                    <!-- Content -->
                    <div class="content fix">
                        <!-- Head -->
            ...
            <div class="footer-widget col-xl-3 col-md-6 col-12 mb-60">
                ...
                <div class="footer-widget-post">
                    <div class="post-wrap">
                        ...
                        <!-- Image -->
                        <a href="{{ $post->url }}" class="image"><img src="/themes/newstv/pad/img/post/post-14.jpg" alt="Post"></a>

                        <!-- Content -->
                        <div class="content">

                            <!-- Title -->
                            <h5 class="title"><a href="{{ $post->url }}">Australia announced squad for Bangladesh tour.</a></h5>
                ...
                <div class="footer-widget-post">
                    <div class="post-wrap">
                        ...
                        <!-- Image -->
                        <a href="{{ $post->url }}" class="image"><img src="/themes/newstv/pad/img/post/post-23.jpg" alt="Post"></a>

                        <!-- Content -->
                        <div class="content">

                            <!-- Title -->
                            <h5 class="title"><a href="{{ $post->url }}">Fish Fry With green vegetables.</a></h5>
                ...
                <div class="footer-widget-post">
                    <div class="post-wrap">
                        ...
                        <!-- Image -->
                        <a href="{{ $post->url }}" class="image"><img src="/themes/newstv/pad/img/post/post-40.jpg" alt="Post"></a>
...
<!-- Main JS -->
<script src="/themes/newstv/pad/js/main.js"></script>

            ...
            <div class="row">
                ...
                <div class="single-sidebar col-lg-12 col-md-6 col-12">
                    <div class="col-sm-12 hidden-xs">
                        <a class="twitter-timeline" data-height="600" href="{{ theme_option('twitter') }}">
                            آخر التغريدات
                        </a>
                        ...
                        <div class="body">
                            ...
                            <div class="sidebar-post-carousel post-block-carousel gadgets-post-carousel">
                                ...
                                <div class="post gadgets-post">
                                    <div class="post-wrap">
                                        <!-- Image -->
                                        <a class="image" href="{{ $post->url }}"><img src="{{ RvMedia::getImageUrl($post->image, 'medium') }}" alt="post"></a>
                                        <!-- Content -->
                                        <div class="content">
                                            <!-- Title -->

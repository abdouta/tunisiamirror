                    ...
                    <div class="post-block-wrapper">
                        ...
                        <div class="head feature-head politic">
                            ...
                            <ul class="post-block-tab-list feature-post-tab-list nav d-sm-block d-md-none">
                                <li><a class="dropdown-toggle" data-toggle="dropdown" href="#">{{__('Cat')}}</a>
                        ...
                        <div class="body pb-0 politic-posts">
                            ...
                            <div class="tab-content">
                                <?php $show = 'show active';?>
                                        <!-- Tab Pane Start-->
                                @foreach($politic->children as $politic_cat)
                                    <div class="tab-pane fade  {{$show}}" id="politic-cat-{{$politic_cat->id}}">
                                            ...
                                            <div class="col-md-8 col-12 mb-20">
                                                ...
                                                <div class="row">
                                                    @foreach($politic_posts as $politic_post )
                                                        <div class="post feature-post post-separator-border col-md-6 col-lg-6 mb-20">
                                                            <div class="post-wrap">
                                            ...
                                            <div class="col-md-4 col-12 mb-20">
                                                ...
                                                <div class="post post-small post-list feature-post post-separator-border">
                                                    <div class="post-wrap">
                                                        ...
                                                        <!-- Image -->
                                                        <a class="image" href="{{ $politic_post_small->url }}"><img
                                        ...
                                        <div class="post post-overlay sports-post col-md-6 mb-20">
                                            <div class="post-wrap">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <!-- Title -->
                                                    <h4 class="title"><a href="{{ $economy_post_small->url }}">{{ $economy_post_small->name }}</a>
                                                    </h4>

                                                    <!-- Meta -->
                                                    <div class="meta fix">
                                                        <span class="meta-item date"><i class="fa fa-clock-o"></i>{{ ArabicDate($economy_post_small->created_at) }}</span>
                                                    </div>
                                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="single-sidebar col-lg-12 col-md-6 col-12">
                            ...
                            <div class="sidebar-block-wrapper">
                                ...
                                <div class="body ">
                                    {!! dynamic_sidebar('sidebar_currencies') !!}
                                ...
                                @if($video_posts)
                                    @foreach($video_posts as $video_post )
                                        <div class="post post-dark col-lg-7 col-12 mb-20">
                                            <div class="post-wrap">
                                                <div class="o-video">
                                                    <iframe id="main-vid" src="https://www.youtube.com/embed/{{ GetYoutubeID($video_post->youtube_url) }}"
                                    ...
                                    <div class="row">
                                        @foreach(\Botble\Blog\Models\Post::getPostsByCategory(51,4) as $video_post_small )
                                            @if($video_post_small->youtube_url)
                                                <div data-yid="{{ GetYoutubeID($video_post_small->youtube_url) }}"  class="col-6 post post-small post-small-youtube post-list post-dark post-separator-border">
                                                    <div class="">
                        ...
                        <div class="body pb-0">
                            ...
                            <div class="tab-content">
                                <?php $show = 'show active';?>
                                        <!-- Tab Pane Start-->
                                @foreach($press->children as $press_cat)
                                    <div class="tab-pane fade  {{$show}}" id="politic-cat-{{$press_cat->id}}">
                                        ...
                                        <div class="post life-style-post">
                                            <div class="post-wrap">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <!-- Read More Button -->
                                                    <a href="#" class="read-more btn">{{__('continue reading')}}</a>
                    ...
                    <div class="post-block-wrapper">
                        ...
                        <div class="body pb-0">
                            ...
                            <div class="tab-content">
                                ...
                                @foreach($sport->children as $sport_cat)
                                    @php
                                    $sport_posts_small=\Botble\Blog\Models\Post::getPostsByCategory($sport_cat->id,3)
                                    ;@endphp

                                    <div class="tab-pane fade {{$show}}" id="sports-cat-{{$sport_cat->id}}">
